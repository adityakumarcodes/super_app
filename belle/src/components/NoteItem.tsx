...
const NoteItem = (props: NoteItemProps) => {
    ...
    return (
        <div>
            {/* Mobile view */}
            {/* <div className="block lg:hidden max-w-75 bg-white border-2 border-black hover:shadow-xl rounded-md select-none">
                <a href={blogPath}>
                    <img src={props.image} alt={props.title} className="rounded-md w-full h-auto" loading="lazy" />
                    ...
                    <div className="p-5">
                        ...
                        <div className="inline-flex items-center py-2 text-center">Read more</div>
                    </div>
                </a>
            </div> */}
